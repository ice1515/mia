...
from perturbation_scaler import perturbation_attack
...
def args_attack():
    ...
    parser.add_argument('--config', type=str, default='configs/TUs_graph_classification_GraphSage_PROTEINS_full.json')
    ...
    parser.add_argument('--scaler', type=float, help='random noise scaler',default=2.0)

    parser.add_argument('--perturb_type', type=str, default='fnz', help='perturbation location', )
    parser.add_argument('--noise_number', type=int, default=50, help='perturb noise samples')
...
def main():
    ...
    result_path = root_path + 'result/scaler/'
